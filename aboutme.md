...
In 2009/2010 I was Visiting Faculty at Google where I got involved in the standardization of JavaScript (aka ECMAScript). My biggest claim to language design fame is the creation of the JavaScript <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Proxy">Proxy API</a> together with <a href="https://ai.google/research/people/author35958">Mark S. Miller</a>, now shipping in all major browsers.
